...
<title>Validasi Surat Daftar Hadir</title>
@section('content')
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <nav class="navbar navbar-light bg-light">
                <h1>Validasi Surat Daftar Hadir</h1>
            </nav>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Validasi Surat Daftar Hadir</li>
            </ol>
          </div></div></div></div>
<section class="content">
      <div class="card card-primary card-outline">
            <div class="card-body">
            <form action="{{url('/adminrpl/updatesuratdhadm',$asurat->id)}}" method="post">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Validasi Anggota</label>
                            <div class="col-2">
                            @foreach($exp1 as $sia)
                            ...
                            <div class="col-4">
                                <button class="add-more btn btn-success " type="button"><i class="glyphicon glyphicon-plus"></i> Validasi
                            </div>
                        </div>
