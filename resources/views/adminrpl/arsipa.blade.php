...
<title>Surat Personalia & SK</title>
@section('content')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Surat Personalia & SK</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              <div class="card-body">
                <nav class="navbar navbar-light bg-light">
                    <h1>Arsip Surat Personalia & SK</h1>
                </nav>
                  ...
                  <tr align="center">
                    <th scope="row"><?php echo e($no++) + (($asurat->currentPage()-1) * $asurat->perPage()) ?></th>
                      ...
                      <td>{{$asadm->js->jenis}}</td>
                        ...
                        <a href="{{url('/adminrpl/downloadskdknadm',$asadm->id)}}" role="button"><i class="fas fa-download"></i></a> 
                        @endif
                        @if($asadm->ni_ang != null)
                        <a href="{{url('/adminrpl/downloadprsadm',$asadm->id)}}" role="button"><i class="fas fa-download"></i></a> 
                        @endif
                      </td>
                  </tr>
                  @endforeach
