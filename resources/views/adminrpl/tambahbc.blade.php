...
<title>Tambah Surat Berita Acara</title>
@section('content')
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <nav class="navbar navbar-light bg-light">
                <h1>Tambah Surat Berita Acara</h1>
            </nav>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Surat Berita Acara</li>
            </ol>
          </div></div></div></div>
<section class="content">
      <div class="card card-primary card-outline">
            <div class="card-body">
            <form action="{{route('simpanberitaacara')}}" method="post">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Peserta Kegiatan </label>
                                <div class="col-sm-10">
                                    <input type="text" id="inputPassword" value="" name="peserta" class="form-control
                                    @error('peserta') is-invalid @enderror" value="{{old('peserta')}}">
                                    @error('peserta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
