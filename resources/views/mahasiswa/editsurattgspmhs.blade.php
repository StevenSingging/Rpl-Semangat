...
<title>Edit Surat Tugas Kelompok</title>
@section('content')
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <nav class="navbar navbar-light bg-light">
                <h1>Edit Surat Tugas Kelompok</h1>
            </nav>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Surat Tugas Kelompok</li>
            </ol>
          </div></div></div></div>
<section class="content">
      <div class="card card-primary card-outline">
            <div class="card-body">
            <form action="{{url('/mahasiswa/updatesuratgspmhs',$psurat->id)}}" method="post">
                    {{ csrf_field() }}
