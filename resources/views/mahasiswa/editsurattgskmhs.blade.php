...
<section class="content">
      <div class="card card-primary card-outline">
            <div class="card-body">
            <form action="{{url('/mahasiswa/updatesuratgskmhs',$psurat->id)}}" method="post">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            @foreach($exp1 as $sia)
                                ...
                                <input type="number" class="form-control" id="inputPassword" value="{{$sia}}" name="ni_ang[]" placeholder="NIM"><br>
                            </div>
                            @endforeach
                            </div>
