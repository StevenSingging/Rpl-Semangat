            ...
            <div class="row">
                  ...
                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Tambah Anggota</label>
                        <div class="col-2">
                            <input type="text" class="form-control" id="inputPassword" name="" placeholder="NIM">
                        </div>
                        <div class="col-3">
                ...
                <div class="modal-footer">
                    <a href="{{url('/mahasiswa/pengajuansuratmhs')}}" type="button" class="btn btn-secondary" data-dismiss="modal">Batal</a>
