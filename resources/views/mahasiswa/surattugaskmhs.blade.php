        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Surat Tugas Kelompok</li>
            </ol>
          </div></div></div></div>
<section class="content">
      <div class="card card-primary card-outline">
            <div class="card-body">
            <form action="{{route('simpansurattugaskmhs')}}" method="post">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-2">
                                ...
                                <input type="number" class="form-control" id="inputPassword" name="ni_ang[]" placeholder="NIM" required>
                            </div>
                            </div>
                            <div class="col-3">
                                <input type="text" class="form-control" id="inputPassword" name="nama_ang[]" placeholder="Nama" required>
                            </div>
                            <div class="col-4">
