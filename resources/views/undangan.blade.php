...
<body>
    <table align="center" >
        <tr>
            <td align="center" ><strong><u>SURAT UNDANGAN&nbsp;</u></strong><br> No: {{$asurat->nomor_surat}} <br><br></td>
        </tr>
    </table>
    <table>
        <tr>
            <td>Salam sejahtera,<br><br>
                Dalam rangka {{$asurat->keterangan}}, kami selaku penyelnggara memohon {{$asurat->nama_mitra}} <br>
                berkenan untuk menjadi {{$asurat->sebagai}}, yang akan diselenggarakan pada :<br>
            </td>
        </tr>
        <tr>
            <td>&emsp;&emsp;&emsp;&emsp;Hari/Tanggal&thinsp;&thinsp;: {{date('d F Y', strtotime($asurat->tanggal))}}</td>
        </tr>
        <tr>
            <td>&emsp;&emsp;&emsp;&emsp;Waktu&emsp;&emsp;&nbsp;&thinsp;&thinsp;&thinsp;  : {{$asurat->waktuml}} - {{$asurat->waktusls}}</td>
        </tr>
        <tr>
            <td>&emsp;&emsp;&emsp;&emsp;Tema&emsp;&emsp;&emsp;&thinsp;&thinsp;  : {{$asurat->tema}}</td>
        </tr>
        <tr>
