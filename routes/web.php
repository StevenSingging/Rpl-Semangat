...
Route::get('/mahasiswa/editsuratmhskegiatan/{id}', '\App\Http\Controllers\MahasiswaController@updatesuratgskmhs')->name('editsuratmhskegiatan');
...
Route::get('/dosen/downloaduratpribadidsn/{id}', '\App\Http\Controllers\DosenController@downloadsurattgsp');
Route::get('/dosen/downloadtgskdsn/{id}', '\App\Http\Controllers\DosenController@downloadsurattgsk');
Route::get('/dosen/downloadskdsn/{id}', '\App\Http\Controllers\DosenController@downloadsuratk');
...
Route::post('/adminrpl/simpandaftarhadir', '\App\Http\Controllers\AdminController@simpandaftarhadir')->name('simpandaftarhadir');
...
Route::post('/adminrpl/updatesurattgspadm/{id}', '\App\Http\Controllers\AdminController@updatesurattgspadm')->name('updatesurattgspadm');
Route::post('/adminrpl/updatevalidasisurattgspadm/{id}', '\App\Http\Controllers\AdminController@updatevalidasisurattgspadm')->name('updatevalidasisurattgspadm');
Route::post('/adminrpl/updatesuratundadm/{id}', '\App\Http\Controllers\AdminController@updatesuratundadm')->name('updatesuratundadm');
Route::post('/adminrpl/updatesuratprsadm/{id}', '\App\Http\Controllers\AdminController@updatesuratprsadm')->name('updatesuratprsadm');
Route::post('/adminrpl/updatesuratdhadm/{id}', '\App\Http\Controllers\AdminController@updatesuratdhadm')->name('updatesuratdhadm');
Route::post('/adminrpl/updatesuratskadm/{id}', '\App\Http\Controllers\AdminController@updatesuratskadm')->name('updatesuratskadm');
Route::post('/adminrpl/updatesuratbcadm/{id}', '\App\Http\Controllers\AdminController@updatesuratbcadm')->name('updatesuratbcadm');
Route::post('/adminrpl/updatesuratsketadm/{id}', '\App\Http\Controllers\AdminController@updatesuratsketadm')->name('updatesuratsketadm');
Route::post('/adminrpl/updatevalidasisuratsketadm/{id}', '\App\Http\Controllers\AdminController@updatevalidasisuratsketadm')->name('updatevalidasisuratsketadm');
...
Route::get('/adminrpl/downloaduratpribadiadm/{id}', '\App\Http\Controllers\AdminController@downloadsurattgsp');
Route::get('/adminrpl/downloadtgskadm/{id}', '\App\Http\Controllers\AdminController@downloadsurattgsk');
Route::get('/adminrpl/downloadsketadm/{id}', '\App\Http\Controllers\AdminController@downloadsuratk');
Route::get('/adminrpl/downloadskdknadm/{id}', '\App\Http\Controllers\AdminController@downloadskdekan');
Route::get('/adminrpl/downloadprsadm/{id}', '\App\Http\Controllers\AdminController@downloadpersonalia');
Route::get('/adminrpl/downloadundadm/{id}', '\App\Http\Controllers\AdminController@downloadundangan');
Route::get('/adminrpl/downloaddhadm/{id}', '\App\Http\Controllers\AdminController@downloaddaftarhadir');
Route::get('/adminrpl/downloadbcadm/{id}', '\App\Http\Controllers\AdminController@downloadberitaacara');
